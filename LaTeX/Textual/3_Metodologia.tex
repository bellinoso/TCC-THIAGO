...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Imagens/flowchart.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Imagens/esquema_eixos.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Imagens/OnShape_Assembly.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Imagens/matriz_completa.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1 \textwidth]{Imagens/janela_programacao.png}
    \caption{}
