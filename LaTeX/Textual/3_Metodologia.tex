...
\begin{itemize}
    ...
    \item \textbf{\textit{Babylon.js}}: biblioteca gráfica baseada em \textit{WebGL} utilizada para renderização tridimensional e manipulação da cena;
    \item \textbf{\textit{Chart.js}}: biblioteca utilizada para geração dos gráficos de posição, velocidade e aceleração das juntas.
\end{itemize}
