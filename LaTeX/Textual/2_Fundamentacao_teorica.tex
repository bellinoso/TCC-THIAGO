...
O planejamento pode ser realizado tanto no espaço cartesiano quanto no espaço das juntas. No presente trabalho, considera-se a interpolação no espaço de juntas, em que cada variável $q_i(t)$ é descrita como uma função contínua do tempo.
