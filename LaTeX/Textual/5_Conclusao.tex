...
O uso de gêmeos digitais permite a realização de testes em ambiente virtual antes da implementação no sistema físico, contribuindo para a redução de riscos e a otimização de trajetórias e processos. Além disso, possibilita a identificação de gargalos operacionais, o treinamento em ambiente simulado e, em aplicações mais avançadas, a antecipação de necessidades de manutenção.
Nesse contexto, o simulador desenvolvido neste trabalho pode ser interpretado como um passo inicial para a implementação de um gêmeo digital, uma vez que permite a análise e validação do comportamento do robô em ambiente virtual. \textcolor{red}{[REFERENCIA]}
