...
A Figura \ref{fig:trajetoria_execucao} apresenta um exemplo de execução de trajetória no simulador. A tabela \ref{tab:trajetoria} mostra os valores das variáveis para cada uma das configurações usadas no exemplo, assim como o tempo definido para cada trecho do percurso.

\begin{table}[H]
\centering
\caption{Posicionamentos configurados ao longo da trajetória}
\label{tab:trajetoria}
\begin{tabular}{c c c c c c c c}
\hline
\textbf{Configuração} & $\boldsymbol{\theta_1}(^\circ)$ & $\boldsymbol{\theta_2}(^\circ)$ & $\boldsymbol{\theta_3}(^\circ)$ & $\boldsymbol{\theta_4}(^\circ)$ & $\boldsymbol{\theta_5}(^\circ)$ & $\boldsymbol{\theta_6}(^\circ)$ &  $\boldsymbol{\Delta t}$ (s)  \\ 
\hline
1 & 180.0 & 90.0 & 0.0 & 180.0 & 0.0 & 0.0 & - \\
2 & 130.0 & 105.0 & 10.0 & 122.4 & 40.8 & 57.6 & 2 \\
3 & 264.0 & 33.6 & 49.0 & 201.6 & 90.0 & 199.2 & 3 \\
4 & 307.2 & 12.0 & -7.2 & 276 & 52.8 & 235.2 & 1 \\
5 & 124.8 & 122.4 & -191.8 & 360 & -75.6 & 151.2 & 3 \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8 \textwidth]{Imagens/graficos_exemplo.png}
